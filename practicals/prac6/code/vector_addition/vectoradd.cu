...
int main(void) {
  ...
  // put your code here
     err_code = cudaMemcpy(d_A, A, N*sizeof(float), cudaMemcpyHostToDevice);
     if(err_code!=cudaSuccess) return(1);
     err_code = cudaMemcpy(d_B, B, N*sizeof(float), cudaMemcpyHostToDevice);
     if(err_code!=cudaSuccess) return(1);
  //----------------------------------------------------------------------
  ...
  // put your code here
    err_code = cudaMemcpy(C, d_C, N*sizeof(float), cudaMemcpyDeviceToHost);
    if(err_code!=cudaSuccess) return(1);
  //----------------------------------------------------------------------
